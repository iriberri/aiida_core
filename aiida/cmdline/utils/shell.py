...
DEFAULT_MODULES_LIST = [
    ...
    ('aiida.orm.nodes.process', 'ProcessNode', 'ProcessNode'),
    ('aiida.orm.nodes.process.calculation', 'CalculationNode', 'CalculationNode'),
    ('aiida.orm.nodes.process.calculation.calcjob', 'CalcJobNode', 'CalcJobNode'),
    ('aiida.orm.nodes.process.calculation.calcfunction', 'CalcFunctionNode', 'CalcFunctionNode'),
    ('aiida.orm.nodes.process.workflow', 'WorkflowNode', 'WorkflowNode'),
    ('aiida.orm.nodes.process.workflow.workchain', 'WorkChainNode', 'WorkChainNode'),
    ('aiida.orm.nodes.process.workflow.workfunction', 'WorkFunctionNode', 'WorkFunctionNode'),
