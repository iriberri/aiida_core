...
db_test_list = {
    ...
    'common': {
        ...
        'orm.nodes': ['aiida.backends.tests.orm.node.test_node'],
        'orm.nodes.data.frozendict': ['aiida.backends.tests.orm.nodes.data.frozendict'],
        'orm.nodes.data.remote': ['aiida.backends.tests.orm.nodes.data.remote'],
        'orm.nodes.data.upf': ['aiida.backends.tests.orm.nodes.data.upf'],
