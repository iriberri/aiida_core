    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.ForeignKey(related_name='dbnodefiles', on_delete=django.db.models.deletion.PROTECT, to='db.DbFile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('uuid', django_extensions.db.fields.UUIDField(editable=False, blank=True)),
                ('repo_name', models.CharField(unique=True, max_length=255)),
                ('repo_uuid', django_extensions.db.fields.UUIDField(auto=False)),
            ],
            options={
            },
            bases=(models.Model,),
