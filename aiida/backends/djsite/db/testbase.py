...
class DjangoTests(AiidaTestImplementation):
    ...
    def create_repo(self):
        ...
        """
        repository = get_repository()
        dbrepo = DbRepository(name=repository.get_name(), uuid=repository.get_uuid())
        dbrepo.save()
    ...
    def tearDownClass_method(self):
        ...
        #                            "{}".format(settings.REPOSITORY_BASE_PATH))
