...
def calcfunction(function):
    ...
    """
    from aiida.orm.nodes import CalcFunctionNode
...
def workfunction(function):
    ...
    """
    from aiida.orm.nodes import WorkFunctionNode
...
class FunctionProcess(processes.Process):
    ...
    def build(func, node_class):
        ...
        :type node_class: :class:`aiida.orm.nodes.process.ProcessNode`
        ...
        return type(
            func.__name__, (FunctionProcess,), {
                ...
                processes.Process.define.__name__: classmethod(_define),
                '_func_args': args,
